...
- **Name:** Or
- **Role/Title:** Investment Analyst at Viola (VC)
- **What I do daily** (1-2 sentences): 
...
- [ ] Task Management (e.g., Asana, Linear, Todoist, Jira): 
- [ ] Chat/Messaging (e.g., Slack, Discord, Teams): 
- [ ] Notes/Documents (e.g., Notion, Obsidian, Google Docs): 
- [ ] Cloud Storage (e.g., Google Drive, Dropbox, OneDrive): 
- [ ] Code Hosting (e.g., GitHub, GitLab): 
...
1. Draft email replies to important messages
2. Track deadlines and remind me before they're due
3. Summarize what happened in WhatsApp while I was away
